...
BOT_TOKEN = environ.get("BOT_TOKEN", "7784747674:AAGvDEzWsNpR_87Lu12T8y42g8_hmGyt3T4")
...
CHANNELS = [
    ...
    for ch in environ.get("CHANNELS", "-1002621610885").split()
]
...
# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://shek899m:LYeq7XljenXxafEs@cluster0.6i1ovul.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get("DATABASE_NAME", "Cluster0")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://shek899m:LYeq7XljenXxafEs@cluster0.6i1ovul.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
COLLECTION_NAME = environ.get("COLLECTION_NAME", "Cluster0")

# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002840767253"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "0"))
request_channel = environ.get("REQUEST_CHANNEL", "-1002684140912")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002837276813"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/cinexhubs")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/cinex_hub")
...
if "DYNO" in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://u-filter-bots.onrender.com/")
